...
public class DHParameter {
    // https://stackoverflow.com/a/33045659
    ...
    private static BigInteger prime = new BigInteger(1, DH_GRP_14_P);
    private static BigInteger generator = new BigInteger("2");

    public static BigInteger getDHPrime() {
        return prime;
    }
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(DHParameter.getDHPrime());
        System.out.println(DHParameter.getGenerator());
    }
}
